...
zh_path = os.path.join(base_zh, "openai-jalapeno-custom-chip-architecture.md")
en_path = os.path.join(base_en, "openai-jalapeno-custom-chip-architecture.md")
...
print("Aug 27 articles successfully written!")
